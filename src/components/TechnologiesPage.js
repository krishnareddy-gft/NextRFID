...
function TechnologiesPage() {
  ...
  const technologies = [
    {
      name: 'Java',
      description: 'Enterprise-grade backend development with robust performance and scalability.',
      icon: (
    ...
    // Add other technology objects similar to TechnologiesScroll.js
  ];
  ...
  return (
    <div className="technologies-page">
      ...
      <div className="tech-page-content">
        <h1 className="tech-page-title">Our Technology Stack</h1>
        <p className="tech-page-description">
          We leverage cutting-edge technologies to deliver robust and scalable RFID solutions
        </p>
